...
# TODO  
# mise a jour de gitlab 
# idee creer une clone de la machine gitlab
#####################################################################
...
8. Install nginx fullhosting
9. Install nginx frontend
10. Install apache fullhosting
11. Install apache frontend
...
4) install_mysql ;;
5) install_postfix ;;
6) install_nullmailer ;;
7) install_graphicsmagick ;;
8) install_nginx_fullhosting ;;
9) install_nginx_frontend ;;
10) install_nginx_fullhosting ;;
11) install_nginx_frontend ;;
12) install_munin_server ;;
q) exit ;;
